const mockedErrorBills = {
    ...
    create(bill) { ////////POST 
      return Promise.reject(new Error('Mock error 500 create'))
    },
    update(bill) { return Promise.reject(new Error('Erreur mock 500 update'))
  }
};
  
  export default {
    bills() {
      return mockedErrorBills
      //return {}
    },
  }
